...
async function sync15Days() {
    ...
    try {
        ...
        const res = await fetch(url, {
            ...
            body: JSON.stringify({
                where: {},
                limit: 2000 // Aumentamos para cubrir más chats históricos y encontrar los de 15 días
            })
        });
        ...
        for (const chat of chats) {
            ...
            if (!phone || phone.length > 15) continue; // Saltar LIDs o IDs internos muy largos
            ...
            // Upsert conversation - NOTA: Dejamos lead_intent y lead_time como NULL
            await pool.query(`
