...
async function checkDb() {
    ...
    const { rows } = await pool.query('SELECT conversation_phone, text_content, timestamp FROM messages WHERE conversation_phone LIKE $1 ORDER BY timestamp DESC LIMIT 5', ['%573114683297%']);
