...
async function inspectCaliConversation() {
    const pool = new Pool({
    ...
    try {
        ...
        const { rows } = await caliPool.query("SELECT * FROM conversations WHERE contact_name LIKE '%Equipo Cali%'");
        console.log('Conversations matching "Equipo Cali" in Cali DB:', rows);
